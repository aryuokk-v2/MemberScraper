...
print (cy+"If you face any problem while runing this script")
print (cy+"contact me on telegram @its_Prince")

print (re+"NOTE :")
print ("1. Telegram only allow to add 200 members in group by one user.")
print ("2. You can Use multiple Telegram accounts for adding more members.")
